...
use App\Models\User;
use Illuminate\Foundation\Testing\RefreshDatabase; // ¡Importante! Borra BD tras cada test
...
class EquipCrudFeatureTest extends TestCase
{
    ...
    {
        parent::setUp();
        // Nos saltamos las Policies para probar solo que el CRUD funciona
    ...
    public function test_es_pot_crear_un_equip()
    {
        ...
        // Verifica que se guardó en la base de datos (SQLite)
